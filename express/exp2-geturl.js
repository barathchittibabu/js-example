...
app.post("/student", (req, res) => {
    ...
    student_list.branchStudent.map((branchstudent)=>{ 
        var branch = student_list.branch.find((branch) => {return branchstudent.branchId == branch.id}) 
        var student = student_list.student.find((student)=> {return branchstudent.studentId == student.id})
